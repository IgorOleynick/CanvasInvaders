...
redAlienA.src = "images/invader11.png";
...
// Set up the sounds
//var soundExplode;
//soundExplode = new Audio('http://canvasinvaders.narod.ru/sounds/explosion.wav');
//soundExplode.volume = 0.9;
...
function resizeCanvas ()
{
	if (isLoaded) {
		...
		bgCanvas.width    = 570;
		bgCanvas.height    = 350;
		glassCanvas.width = 570;
		glassCanvas.height = 350;
